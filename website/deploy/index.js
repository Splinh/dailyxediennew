  ...
  card.innerHTML = `
    <div class="product-card__image">
      ...
      <div class="product-card__actions">
        <button class="product-card__action-btn wishlist-btn" aria-label="Yêu thích">${ICONS.heart}</button>
        <button class="product-card__action-btn" aria-label="Xem nhanh">${ICONS.eye}</button>
      </div>
    </div>
