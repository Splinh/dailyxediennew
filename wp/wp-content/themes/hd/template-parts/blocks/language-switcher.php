...
<div class="relative inline-block text-left">
	<button type="button" data-fx-dropdown-toggle aria-label="<?php esc_attr_e( 'Chọn ngôn ngữ', 'hd' ); ?>" class="inline-flex items-center gap-1.5 p-1.5 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-black/5 dark:hover:bg-white/7 transition-colors cursor-pointer border-none bg-transparent" aria-expanded="false" aria-haspopup="true">
