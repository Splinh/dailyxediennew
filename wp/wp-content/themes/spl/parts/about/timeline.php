				...
				<?php foreach ( $items as $index => $item ) : ?>
					...
					if ( empty( $img_url ) || ! str_contains( (string) $img_url, 'timeline_20' ) ) {
						$default_milestone_images = [
							get_template_directory_uri() . '/resources/img/timeline_2013_founding_1786175168990.png',
							get_template_directory_uri() . '/resources/img/timeline_2015_factory_1786175183412.png',
							get_template_directory_uri() . '/resources/img/timeline_2018_scale_1786175198872.png',
							get_template_directory_uri() . '/resources/img/timeline_2021_digital_1786175211739.png',
							get_template_directory_uri() . '/resources/img/timeline_2023_ai_ebike_1786175227144.png',
							get_template_directory_uri() . '/resources/img/timeline_2024_network_1786175240864.png',
							get_template_directory_uri() . '/resources/img/timeline_2026_showroom3s_1786175252670.png',
						];
