...
<section class="relative w-full bg-gradient-to-br from-[#0B2545] via-[#13315C] to-[#0A192F] overflow-hidden py-16 md:py-24 text-center">
	<div class="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%,rgba(245,158,11,0.15),transparent_50%)]"></div>
	<div class="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(14,165,233,0.12),transparent_50%)]"></div>
	
	<div class="relative z-10 max-w-7xl mx-auto px-4">
		<?php if ( $tagline ) : ?>
			<div class="inline-flex items-center gap-2 bg-amber-500/10 backdrop-blur-sm border border-amber-500/30 rounded-full px-4 py-2 text-xs font-black text-amber-400 mb-5 shadow-sm">
				<svg class="w-3.5 h-3.5 text-amber-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.25-2.5 3.5-2.5 3.5h20c0 0-1-2.25-2.5-3.5L12 2 4.5 16.5z"/></svg>
		...
		<?php if ( $subtitle ) : ?>
			<p class="text-sm md:text-base text-slate-200/90 mt-4 max-w-2xl mx-auto leading-relaxed">
		...
		<div class="flex flex-wrap gap-3 justify-center mt-8">
			<?php if ( $btn_text_1 ) : ?>
				<a href="<?php echo esc_url( $btn_link_1 ); ?>" class="inline-flex items-center gap-2 bg-amber-500 hover:bg-amber-400 text-slate-950 px-7 py-3.5 rounded-xl font-black text-sm transition-all transform hover:scale-[1.03] shadow-lg shadow-amber-500/25">
					<svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><line x1="22" y1="2" x2="11" y2="13"/><polygon points="22 2 15 22 11 13 2 9 22 2"/></svg>
