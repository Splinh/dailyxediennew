...
if ( empty( $features ) ) {
	$features = [
		...
		[
			...
			'title'        => __( 'Kết Nối Bluetooth & App Quản Lý Xe Thông Minh', 'spl' ),
			'description'  => __( 'Kết nối Bluetooth 5.0 với app chuyên dụng trên smartphone giúp theo dõi hành trình GPS, kiểm tra pin real-time, chẩn đoán lỗi từ xa và cập nhật firmware OTA. Tính năng chống trộm thông minh gửi cảnh báo khi xe bị di chuyển bất thường. Trang bị trên dòng AI Ebike thế hệ mới.', 'spl' ),
			'image'        => get_theme_file_uri( 'resources/img/smart-app-connect.png' ),
			'details'      => [
				[ 'label' => __( 'Kết nối', 'spl' ), 'value' => __( 'Bluetooth 5.0 Low Energy', 'spl' ) ],
				[ 'label' => __( 'Chống trộm', 'spl' ), 'value' => __( 'GPS + cảnh báo real-time', 'spl' ) ],
				[ 'label' => __( 'Tương thích', 'spl' ), 'value' => __( 'iOS 14+ & Android 10+', 'spl' ) ],
			],
		],
	];
}
