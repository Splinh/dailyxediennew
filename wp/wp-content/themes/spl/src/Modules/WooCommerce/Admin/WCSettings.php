 ...
 *
 * @package SPL\Modules\WooCommerce\Admin
 */

namespace SPL\Modules\WooCommerce\Admin;
...
final class WCSettings {
	...
	public static function renderPage(): void {
		...
		if ( 'saved' === $msg ) {
			echo '<div class="notice notice-success is-dismissible"><p>' . esc_html__( 'Settings saved.', 'SPL' ) . '</p></div>';
		}
		...
		<div class="wrap hd-wc-wrap">
			...
			<form method="post" action="">
				...
				<div class="hd-wc-tab-content" id="tab-settings">
					<h2><?php esc_html_e( 'Features', 'SPL' ); ?></h2>
					<p class="description"><?php esc_html_e( 'Enable or disable WooCommerce enhancement features. Sub-feature settings tabs appear automatically when enabled.', 'SPL' ); ?></p>
				...
				foreach ( $features as $featureClass ) :
					...
					<div class="hd-wc-tab-content" id="tab-<?php echo esc_attr( $slug ); ?>" style="display:none;">
						<h2><?php echo esc_html( $label . ' — ' . __( 'Settings', 'SPL' ) ); ?></h2>
						<table class="form-table" role="presentation">
	...
	private static function getFeatureLabel( string $slug ): string {
		$labels = [
			'swatches'       => __( 'Variation Swatches', 'SPL' ),
			'gallery_thumbs' => __( 'Product Gallery', 'SPL' ),
			'quick_view'     => __( 'Quick View', 'SPL' ),
			'ajax_filter'    => __( 'AJAX Product Filter', 'SPL' ),
		];
